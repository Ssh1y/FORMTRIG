...
| ---: | --- | --- | --- | --- | ---: | --- | ---: | --- |
| 1 | LIBARCHIVE_2936 | real_cve | libarchive | binary-state-null | 115 | `real_cve_replacement` | 4 | inspect short-gate benefit readout; promote only positive endpoint/pre-trigger evidence, otherwise refine BindingSpec/root-state guidance |
