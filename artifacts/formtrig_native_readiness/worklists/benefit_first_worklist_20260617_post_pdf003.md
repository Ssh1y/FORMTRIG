...
Generated: `2026-06-18T02:58:48+00:00`
...
- python3 tools/check_magma_matched_finalize_ready.py --active-runs artifacts/formtrig_native_readiness/worklists/active_matched_runs_20260618.json --target-id PDF003 --out-json artifacts/formtrig_native_readiness/raw/pdf003_matched_7200s_3rep_20260617T224500Z/finalize_readiness.json --out-md artifacts/formtrig_native_readiness/raw/pdf003_matched_7200s_3rep_20260617T224500Z/finalize_readiness.md --fail-if-not-ready
...
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL015 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SSL015.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- seed readiness with reached non-trigger seeds
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PDF016 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/PDF016.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SQL013 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SQL013.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL009 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SSL009.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PHP003 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/PHP003.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PHP010 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/PHP010.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PHP011 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/PHP011.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SQL015 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SQL015.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL005 --durations 600 --jobs 3 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SSL005.list --duration 600 --jobs 3 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
