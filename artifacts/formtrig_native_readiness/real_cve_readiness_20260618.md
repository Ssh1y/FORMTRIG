...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | ---: | --- |
| 1 | GPAC_3403 | compound-sequence-lifecycle | `short_gate_triaged` | yes | yes | yes | yes | yes | 1 | repair object-alias BindingSpec role because PoC snapshot triage shows current `same_object` binding is not on the crash path, then rerun matched endpoint experiments |
