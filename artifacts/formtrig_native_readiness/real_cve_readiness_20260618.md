...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | ---: | --- |
| 1 | GPAC_3403 | compound-sequence-lifecycle | `needs_binding_role_repair` | yes | yes | yes | yes | yes | 1 | repair BindingSpec role coverage before matched endpoint long-runs; do not promote mechanism-limited validation as complete evidence |
...
- Blockers: same_object_binding_not_on_crash_path@artifacts/formtrig_native_readiness/binding_validation/GPAC_3403.native_b2_poc_snapshot_triage_20260619.validation.json: Do not promote GPAC_3403 B2 as complete same-object lifecycle evidence. Repair the object-alias role around the actually reached cleanup/free path, or reseed with an input that reaches gf_bs_new_cbk_buffer before long endpoint runs.; partial_mechanism_missing_role_coverage@artifacts/formtrig_native_readiness/binding_validation/GPAC_3403.native_b2_same_object_repair_60s_20260618.validation.json: BindingSpec has partial mechanism coverage with missing role samples; alias_role_repaired_cleanup_use_not_captured@artifacts/formtrig_native_readiness/binding_validation/GPAC_3403.native_b3_nalu_reassign_alias_20260619.validation.json: Keep B3 as the current GPAC_3403 candidate. Next repair should focus on making cleanup-use observable on the aborting full PoC, either by binding a pre-call cleanup state that is sampled before gf_bs_del aborts or by improving snapshot-on-abort coverage.
