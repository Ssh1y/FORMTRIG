...
| P3 | 25 | PDF013 | magma |  | draft_binding_spec_then_short_screen | blocked | Find whether a binary or lifecycle TC can be converted into accepted non-trigger progress and then a faster terminal outcome than faithful baselines. |
| P3 | 26 | PDF015 | magma |  | draft_binding_spec_then_short_screen | blocked | Find whether a binary or lifecycle TC can be converted into accepted non-trigger progress and then a faster terminal outcome than faithful baselines. |
| P3 | 27 | PDF018 | magma |  | draft_binding_spec_then_short_screen | blocked | Find whether a binary or lifecycle TC can be converted into accepted non-trigger progress and then a faster terminal outcome than faithful baselines. |
| P3 | 28 | SND014 | magma |  | draft_binding_spec_then_short_screen | blocked | Find whether a binary or lifecycle TC can be converted into accepted non-trigger progress and then a faster terminal outcome than faithful baselines. |
| P3 | 29 | SND022 | magma |  | draft_binding_spec_then_short_screen | blocked | Find whether a binary or lifecycle TC can be converted into accepted non-trigger progress and then a faster terminal outcome than faithful baselines. |
| P3 | 30 | SQL009 | magma |  | draft_binding_spec_then_short_screen | blocked | Find whether a binary or lifecycle TC can be converted into accepted non-trigger progress and then a faster terminal outcome than faithful baselines. |
...
- Blocking issue:
- latest B7 relation endpoint gate with df-structure-op-diverse plus .hevc endpoint staging still produced terminal _T=0 and ASAN/double-free=0. Endpoint replay now carries op48/op49/op51 into the standard gate and restores HEVC/type49 proximity, so retained selection and importer routing are no longer the blocker. Alias-gap analysis shows 19 runtime records with release=reassign and cleanup pointer values, all at D_F_spec_lifted=2, but 0 records prove release=reassign=cleanup; release/reassign has 4 distinct pointer values and cleanup has 3 distinct pointer values. The remaining blocker is sample/lifecycle correlation and cleanup GF_BitStream->original ownership/free closure.
- Mechanism evidence required after benefit:
...
- Current primary benefits:
- GPAC now has stable TC-rooted pre-trigger guidance, typed-retained endpoint packaging, retained-selection repair, importer-routing repair, and explicit alias-gap diagnosis. The latest full B7 gate saved 22 non-trigger progress entries, observed D_F_spec_lifted movement 2..5, retained 221 typed candidates, selected op48/op49/op51 under df-structure-op-diverse, and replayed 128/128 HEVC-import files with 71 L-HEVC files and 59 nal_type_49_not_handled files. This is strong mechanism/proximity evidence, but endpoint closure is still missing because ASAN/double-free remains 0 and alias-gap analysis has no complete release=reassign=cleanup record.
- Post-unblock commands or steps:
- repair cleanup GF_BitStream->original ownership so it equals the release/reassign sample-data pointer
- rerun `scripts/run_gpac3403_b7_relation_endpoint_gate.sh --duration 600 --reps 1 --jobs 1` after cleanup/free alias repair
...
- artifacts/formtrig_native_readiness/gpac3403_endpoint_scale_repair_20260619.json
- artifacts/formtrig_native_readiness/gpac3403_endpoint_scale_repair_20260619.md
...
- artifacts/formtrig_native_readiness/gpac3403_b7_relation_endpoint_gate_dfstructure_20260619.md
- artifacts/formtrig_native_readiness/raw/gpac3403_b7_relation_endpoint_gate_dfstructure_20260619T234925Z/runs/formtrig_rep1/typed_retained_endpoint_replay_summary.json
- artifacts/formtrig_native_readiness/raw/gpac3403_b7_relation_endpoint_gate_dfstructure_20260619T234925Z/runs/formtrig_rep1/typed_retained_audit_package.json
- artifacts/formtrig_native_readiness/gpac3403_b7_import_safe_extractor_ops_probe_20260620.json
- artifacts/formtrig_native_readiness/gpac3403_b7_import_safe_extractor_ops_probe_20260620.md
- artifacts/formtrig_native_readiness/raw/gpac3403_b7_import_safe_extractor_ops_probe_20260620T001443Z/summary.json
- artifacts/formtrig_native_readiness/gpac3403_b7_typedops52_selection_gap_20260620.json
- artifacts/formtrig_native_readiness/gpac3403_b7_typedops52_selection_gap_20260620.md
- artifacts/formtrig_native_readiness/gpac3403_b7_endpoint_selection_suffix_repair_20260620.json
- artifacts/formtrig_native_readiness/gpac3403_b7_endpoint_selection_suffix_repair_20260620.md
- artifacts/formtrig_native_readiness/gpac3403_b7_relation_endpoint_gate_opdiverse_hevc_20260620.json
- artifacts/formtrig_native_readiness/gpac3403_b7_relation_endpoint_gate_opdiverse_hevc_20260620.md
- artifacts/formtrig_native_readiness/raw/gpac3403_b7_relation_endpoint_gate_opdiverse_hevc_20260620T004121Z/runs/formtrig_rep1/typed_retained_endpoint_replay_summary.json
- artifacts/formtrig_native_readiness/raw/gpac3403_b7_relation_endpoint_gate_opdiverse_hevc_20260620T004121Z/runs/formtrig_rep1/typed_retained_audit_package.json
- artifacts/formtrig_native_readiness/gpac3403_b7_alias_gap_analysis_20260620.json
- artifacts/formtrig_native_readiness/gpac3403_b7_alias_gap_analysis_20260620.md
- artifacts/formtrig_native_readiness/raw/gpac3403_b7_relation_endpoint_gate_opdiverse_hevc_20260620T004121Z/runs/formtrig_rep1/alias_gap_analysis.json
- artifacts/formtrig_native_readiness/raw/gpac3403_b7_relation_endpoint_gate_opdiverse_hevc_20260620T004121Z/runs/formtrig_rep1/alias_gap_analysis.md
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PHP011 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SQL015 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL005 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id TIF011 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id TIF014 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id XML003 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id XML004 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id XML010 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL008 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL012 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL017 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PDF010 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SSL002 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id LUA002 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PHP001 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id TIF009 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id LUA003 --durations 600 --jobs 4 --reps 3
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PDF013 --durations 600 --jobs 4 --reps 3
...
### P3 PDF015 - draft_binding_spec_then_short_screen
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PDF015 --durations 600 --jobs 4 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/PDF015.list --duration 600 --jobs 4 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json

### P3 PDF018 - draft_binding_spec_then_short_screen
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id PDF018 --durations 600 --jobs 4 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/PDF018.list --duration 600 --jobs 4 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json

### P3 SND014 - draft_binding_spec_then_short_screen
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SND014 --durations 600 --jobs 4 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SND014.list --duration 600 --jobs 4 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json

### P3 SND022 - draft_binding_spec_then_short_screen
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SND022 --durations 600 --jobs 4 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SND022.list --duration 600 --jobs 4 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json

### P3 SQL009 - draft_binding_spec_then_short_screen
...
- typed mutation, if used, is BindingSpec-provenance tagged
- Post-unblock commands or steps:
- scripts/run_magma_baselines.sh --target-id SQL009 --durations 600 --jobs 4 --reps 3
- scripts/run_formtrig_manifest_batch.sh --manifest-list artifacts/formtrig_native_readiness/manifests/SQL009.list --duration 600 --jobs 4 --continue-on-fail
- Evidence paths:
- artifacts/magma_canary_inventory.json
...
| 143 | SSL011 | control_or_negative | do_not_promote | manual | control_or_negative_not_main_budget |
| 144 | SSL015 | control_or_negative | do_not_promote |  | control_or_negative_not_main_budget |
| 145 | PNG007 | control_or_negative | do_not_promote | manual | control_or_negative_not_main_budget |
| 146 | PDF016 | control_or_negative | demote_to_control_or_negative | not_visible_baseline_time_cost_acceptable | sota_pain_triage_not_main_budget |
